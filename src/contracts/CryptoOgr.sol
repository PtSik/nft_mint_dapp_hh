...
contract CryptoOgr is ERC721Enumerable, Ownable {
    ...
    function payToMint()public payable {
        ...
        require(supply <= maxSupply, "Sorry all NFTs sold out!");
        require(msg.value >= 0 ether, "Sorry insufficient funds!");

        if(msg.sender != owner()) {
            require(msg.value >= cost, "Sorry insufficient funds!");
        }
